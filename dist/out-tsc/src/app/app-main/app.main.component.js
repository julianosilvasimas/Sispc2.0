...
import { Component, Renderer2, NgZone, EventEmitter, Output } from '@angular/core';
...
let AppMainComponent = class AppMainComponent {
    constructor(renderer, zone, authService, router) {
...
], AppMainComponent.prototype, "header", void 0);
AppMainComponent = tslib_1.__decorate([
    Component({
        selector: 'app-main',
