...
let ForecastenergiaaguaComponent = class ForecastenergiaaguaComponent {
...
ForecastenergiaaguaComponent = tslib_1.__decorate([
    Component({
...
export { ForecastenergiaaguaComponent };
// this.UnidadesDaClasse = response.filter((unidades) => {
//   return unidades.classificacao === this.classificacao;
// })
//# sourceMappingURL=forecastenergiaagua.component.js.map