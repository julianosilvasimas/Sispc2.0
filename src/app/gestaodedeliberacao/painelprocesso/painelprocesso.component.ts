...
export class PainelprocessoComponent implements OnInit {
  ...
  imprimir(){
    ...
    this.print.criaPDF(this.modelo,  ("000000" + this.ndeliberacao).slice(-6)+'/'+this.ano ,this.rua, this.bairro, this.cidade,
     this.dataJulgado,this.processo, this.termo, this.parseDate(this.dataNotificacao), this.matricula.toString(), this.irreg1,this.irreg2 , this.irreg3 ,
        ...
        .subscribe(
          processo  => {
            ...
            // }catch(e){
              ...
              this.service.InputDeliberacao(this.irregularidadeId,	null,	null,	 this.dataDefesa,	
                this.mesRetroativo, n,	p,	this.contrato,	this.matricula, c, cp, this.checkOcorrencia.toString(),
                 this.termo, sessionStorage.getItem('nome'), this.protocolo, this.cartacedoc)
              .subscribe(
                response => {
